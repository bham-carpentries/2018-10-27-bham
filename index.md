...
address: "CCB Large Meeting & Teaching Room, Haworth Building (Y2)"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
latlng: "52.450237,-1.934362"       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use https://www.latlong.net/)
humandate: "Monday 24th and Tuesday 25th September"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Mark Slater", "Simon Branford"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
  ...
  <ul>
    <li>Particpants must bring a laptop with a Mac, Linux, or Windows operating system 
      (not a tablet, Chromebook, etc.). They should have a few specific software packages 
	    installed (listed <a href="#setup">below</a>).</li>
